...
const features = [
  ...
  },
  {
    ...
    description: "સ્માર્ટ ક્લાસરૂમ, કમ્પ્યુટર લેબ, અને ઑફ્લાઇન પુસ્તકાલય જેવી આધુનિક સુવિધાઓ.",
  },
  {
    icon: Palette,
  ...
  },
  {
    icon: Trophy,
    title: "રમતગમત",
    description: "એથલેટીસ રમતો, ફૂટબોલ, કબડ્ડી, ખો-ખો જેવી રમતો માટે ઉત્તમ મેદાન અને તાલીમ.",
  },
  {
    icon: Users,
