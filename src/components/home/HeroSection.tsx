  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative container py-16 md:py-24 lg:py-32">
        ...
        {/* Stats */}
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
          {[
            { icon: Users, value: "2000+", label: "વિદ્યાર્થીઓ" },
            { icon: BookOpen, value: "50+", label: "અનુભવી શિક્ષકો" },
            { icon: Award, value: "25+", label: "વર્ષનો અનુભવ" },
          ].map((stat, index) => (
            <div
              key={index}
              className="flex items-center justify-center gap-4 p-6 rounded-xl bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20"
            >
